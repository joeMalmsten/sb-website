...
.directive('appTable', ['$timeout', '_', function($timeout, _) {
    return {
        restrict: 'E',
        replace: true,
        templateUrl: './../views/appTable.html',
        ...
        link: function($scope, element) {
            ...
            function initTableData() {
                if ($scope.tableData && $scope.tableData.length) {
                    ...
                    $scope.filter.input.value = '';

                    $scope.predicate = [sanitizePredicate($scope.tableColumns[0])];
                    $scope.reverse = true;

                    tbody = elem.find('.app-tbody');
                    tbodyRows = tbody.find('.tbody-rows');
                    trows = tbodyRows.find('.app-tr');
                    ...
                    $timeout(function() {
                        ...
                        scrollBarMargin['margin-right'] = '-' + scrollBarWidth + 'px';
                        tbodyRows.css(scrollBarMargin);
